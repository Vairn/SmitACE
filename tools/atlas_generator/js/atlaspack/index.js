...
Atlas.prototype._ontoCanvas = function(node) {
  if (node && this.img && this.canvas) {
    ...
    atlasCallback(this.img.layerIndex, this.img.type, this.img.fullWidth, {x: this.img.squareX, z: this.img.squareZ}, {x: this.img.screenPosX, y: this.img.screenPosY} , node.rect);
  }
  return node;
};
