...
Dependencies (via FetchContent): GLFW 3.4, Dear ImGui **`v1.92.7-docking`** (the docking branch tag; Git must be available for the first configure). The editor uses **OpenGL 3.0** via `imgui_impl_opengl3`.
